    ...
    <AppShell active="/">
      ...
      <div className="grid grid-3">
        <Link className="card tile" href="/documents">
          ...
          <span><h3>העלה חשבונית</h3><p>PDF, תמונה או אקסל. בהמשך נוסיף זיהוי אוטומטי.</p></span>
        </Link>
        <Link className="card tile" href="/business">
          <span className="icon-bubble icon-green"><PackageSearch size={23} /></span>
          <span><h3>ניהול ספקים ומוצרים</h3><p>מאגר ספקים, מוצרים, ברקודים ומחירי קנייה.</p></span>
        </Link>
        <Link className="card tile" href="/reports">
          <span className="icon-bubble icon-orange"><BarChart3 size={23} /></span>
          <span><h3>דוחות ותובנות</h3><p>רווחיות, הוצאות, התייקרויות והשוואות מחירים.</p></span>
        </Link>
      </div>
